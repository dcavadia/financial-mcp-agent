...
DEFAULT_INPUT_FILE = "commoditiesnews.txt"
...
async def init():
    rag = LightRAG(
        ...
        llm_model_max_token_size=26624,
        llm_model_kwargs={
            "host": "http://localhost:11434",
            "options": {
            "num_ctx": 26624,  # 26K context (26*1024)
            "num_gqa": 4,      # Grouped-query attention for memory efficiency
